    ...
    def setup_ui(self):
        ...
        for i, step in enumerate(self.timeline_data['timeline']):
            ...
            if i < len(self.timeline_data['timeline']) - 1:
                ...
                line.setStyleSheet(f"color: {'#4CAF50' if step['completed'] else '#ccc'}; margin-left: 13px;")
...
class OrderItemWidget(QFrame):
    ...
    def setup_ui(self):
        ...
        details_text = f"{self.get_order_type_icon()} {self.get_order_type_label()} | "
        ...
        if self.order_data['status'] == 'completed':
            ...
            reorder_btn.setMaximumWidth(120)
